...
import com.youku.java.raptor.boot.BeanExecutor;
...
@ComponentScan(basePackages = {
		...
		"com.youku.java.copyright.mapperlog",
		...
		"com.youku.java.copyright.cron",
		"com.youku.java.copyright.batch"})
@RuntimeSpringBeans(mode = "batch")
public class BatchBeans {
	...
	@Bean
	public BeanExecutor beanExecutor() {
	    return new BeanExecutor();
	}
