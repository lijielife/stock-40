...
@ComponentScan(basePackages = {
		...
		"com.youku.java.copyright.thread",
...
//        instance.setUrl("jdbc:mysql://" + config.coreDbIp + ":" + config.coreDbPort + "/" + config.coreDbName
//                +"?useUnicode=true&characterEncoding=utf8");
//        instance.setUsername(config.coreDbUserName);                                  
